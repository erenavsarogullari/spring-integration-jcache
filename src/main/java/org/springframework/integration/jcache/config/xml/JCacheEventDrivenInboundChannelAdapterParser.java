...
import org.springframework.integration.jcache.inbound.JCacheEventDrivenMessageProducer;

import reactor.util.StringUtils;

/**
 * JCache Event Driven Inbound Channel Adapter Parser parses
 * {@code <int-jcache:inbound-channel-adapter />} configuration.
 *
 * @author Eren Avsarogullari
 * @since 1.0.0
 */
public class JCacheEventDrivenInboundChannelAdapterParser extends AbstractSingleBeanDefinitionParser {
	...
	protected Class<?> getBeanClass(Element element) {
		return JCacheEventDrivenMessageProducer.class;
	}
